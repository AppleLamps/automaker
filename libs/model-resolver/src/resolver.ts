...
const isOpenAIReasoningModel = (modelKey: string): boolean => /^o\d/.test(modelKey);
...
export function resolveModelString(
  ...
  // OpenRouter model strings - pass through unchanged
  ...
  // OpenAI model strings - pass through unchanged
  if (modelKey.startsWith('gpt-') || isOpenAIReasoningModel(modelKey)) {
    return modelKey;
  }

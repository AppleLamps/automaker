...
export type ModelProvider = 'claude' | 'openai' | 'openrouter';

/**
 * ProviderSettings - Optional per-provider overrides for API configuration
 */
...
export interface GlobalSettings {
  ...
  /** Optional provider-specific overrides (base URL, headers, timeouts) */
  providerSettings?: {

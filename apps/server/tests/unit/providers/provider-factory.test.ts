...
describe('provider-factory.ts', () => {
  ...
  describe('getProviderForModel', () => {
    ...
    describe('Unknown models', () => {
      ...
      it('should return OpenAIProvider for o-series models', () => {
        const provider = ProviderFactory.getProviderForModel('o1');
        expect(provider).toBeInstanceOf(OpenAIProvider);
      });

      it('should return OpenRouterProvider for openrouter models', () => {
        const provider = ProviderFactory.getProviderForModel('openrouter/auto');
  ...
  describe('getAllProviders', () => {
    ...
    it('should include OpenAIProvider', () => {
      const providers = ProviderFactory.getAllProviders();
      const hasOpenAIProvider = providers.some((p) => p instanceof OpenAIProvider);
      expect(hasOpenAIProvider).toBe(true);
    });

    it('should include OpenRouterProvider', () => {
      const providers = ProviderFactory.getAllProviders();
      const hasOpenRouterProvider = providers.some(
        (p) => p instanceof OpenRouterProvider
      );
  ...
  describe('getProviderByName', () => {
    ...
    it("should return OpenRouterProvider for 'openrouter'", () => {
      const provider = ProviderFactory.getProviderByName('openrouter');
      expect(provider).toBeInstanceOf(OpenRouterProvider);
    });

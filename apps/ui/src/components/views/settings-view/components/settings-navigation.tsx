  ...
  return (
    <nav
      className={cn(
        ...
        'bg-linear-to-b from-card/80 via-card/60 to-card/40 backdrop-blur-xl'
      )}
    >
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  isActive
                    ? [
                      'bg-linear-to-r from-brand-500/15 via-brand-500/10 to-brand-600/5',
                      'text-foreground',
              ...
              >
                ...
                {isActive && (
                  <div className="absolute inset-y-0 left-0 w-0.5 bg-linear-to-b from-brand-400 via-brand-500 to-brand-600 rounded-r-full" />
                )}
                <Icon
                  className={cn(

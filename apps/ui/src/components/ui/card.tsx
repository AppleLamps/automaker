  ...
  return (
    <div
      ...
      className={cn(
        ...
        gradient &&
        'relative before:absolute before:inset-0 before:rounded-xl before:p-[1px] before:bg-linear-to-br before:from-white/20 before:to-transparent before:pointer-events-none before:-z-10',
        className
      )}
      {...props}
    />
